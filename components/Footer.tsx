    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <h2 className="text-2xl font-bold text-white mb-3">PhysioWithUs</h2>
            <p className="text-sm text-gray-400 mb-4">
              Expert physiotherapy care in Noida. Helping you recover, move better, and live pain-free.
            </p>
            {/* Social placeholders */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@physiowithus.com" className="hover:text-white transition-colors">info@physiowithus.com</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} PhysioWithUs. All rights reserved.
        </div>
      </div>
    </footer>
  );
